...
| [sktime](https://github.com/alan-turing-institute/sktime) | Python | A unified framework for machine learning with time series. It provides specialized time series algorithms and scikit-learn compatible tools to build, tune and validate time series models for multiple learning problems, including: Forecasting, Time series classification, Time series regression. | BSD 3-Clause | :heavy_check_mark:
| [sktime-dl](https://github.com/sktime/sktime-dl) | Python | An extension package for deep learning with Tensorflow/Keras for sktime, a scikit-learn compatible Python toolbox for learning with time series and panel data. | BSD 3-Clause | ❌
